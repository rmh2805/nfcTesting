    ...
    if (uidLength == 7)
    {
      ...
      for (uint8_t i = 0; i < 135; i++) 
      {
        ...
        if (success) 
        {
          ...
          for(size_t i = 0; i < 4; i++) {
            Serial.print(" ");
            if(data[i] < 128) Serial.print('0');
            if(data[i] < 64) Serial.print('0');
            if(data[i] < 32) Serial.print('0');
            if(data[i] < 16) Serial.print('0');
            if(data[i] < 8) Serial.print('0');
            if(data[i] < 4) Serial.print('0');
            if(data[i] < 2) Serial.print('0');
